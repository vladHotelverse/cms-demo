...
const translations = {
  es: {
    ...
    showingReservationsForDays: "Mostrando reservas para 3 días",
    ...
    comprehensiveSalesDescription: "Dashboard completo de rendimiento de ventas y seguimiento de comisiones",
    refresh: "Actualizar",
    export: "Exportar",
    filters: "Filtros",
    checkIn: "Check-in",
    ...
    roomUpsells: "Mejoras de Habitación",
    ...
    averageRequest: "Promedio/Solicitud",
    totalUpgrades: "Total de Mejoras",
    vsLastMonth: "vs mes pasado",
    revenueGoal: "Meta de Ingresos",
    upsellGoal: "Meta de Upsell",
    targetAchievement: "Logro de Meta",
    progress: "Progreso",
    roomAssignments: "Asignaciones de Habitación",
    monthlyPerformanceBreakdown: "Desglose de Rendimiento Mensual",
    monthlyPerformance: "Rendimiento Mensual",
    upsell: "Upsell",
    abs: "ABS",
    roomNumber: "Número de Habitación",
    room: "Habitación",
    revenueVsTargetTrend: "Tendencia Ingresos vs Meta",
    revenueTrend: "Tendencia de Ingresos",
    target: "Meta",
    totalAmount: "Monto Total",
    amountAccepted: "Monto Aceptado",
    amountCancelled: "Monto Cancelado",
    accepted: "Aceptado",
    pending: "Pendiente",
    cancelled: "Cancelado",
    unmanaged: "Sin Gestionar",
    other: "Otro",
    roomManagementDistribution: "Distribución Gestión de Habitaciones",
    roomManagement: "Gestión de Habitaciones",
    extrasManagementDistribution: "Distribución Gestión de Extras",
    extrasManagement: "Gestión de Extras",
    weeklyRequestTrend: "Tendencia Semanal de Solicitudes",
    ...
    totalUpsells: "Total de Upsells",
    totalExtras: "Total de Extras",
    commissionGoal: "Meta de Comisión",
    teamEarnings: "Ganancias del Equipo",
    totalTeamCommission: "Comisión Total del Equipo",
    thisMonth: "Este Mes",
    ytd: "Año a la Fecha",
    topPerformers: "Mejores Ejecutores",
    rank: "Rango",
    totalSales: "Ventas Totales",
    agentPerformanceBreakdown: "Desglose de Rendimiento por Agente",
  ...
  en: {
    ...
    showingReservationsForDays: "Showing reservations for 3 days",
    ...
    comprehensiveSalesDescription: "Comprehensive sales performance and commission tracking dashboard",
    refresh: "Refresh",
    export: "Export",
    filters: "Filters",
    checkIn: "Check-in",
    ...
    room: "Room",
    revenueVsTargetTrend: "Revenue vs Target Trend",
    revenueTrend: "Revenue Trend",
    target: "Target",
    totalAmount: "Total Amount",
    amountAccepted: "Amount Accepted",
    ...
    unmanaged: "Unmanaged",
    other: "Other",
    roomManagementDistribution: "Room Management Distribution",
    roomManagement: "Room Management",
    extrasManagementDistribution: "Extras Management Distribution",
    extrasManagement: "Extras Management",
    weeklyRequestTrend: "Weekly Request Trend",
    ...
    totalUpsells: "Total Upsells",
    totalExtras: "Total Extras",
    commissionGoal: "Commission Goal",
    teamEarnings: "Team Earnings",
    totalTeamCommission: "Total Team Commission",
    thisMonth: "This Month",
    ytd: "YTD",
    topPerformers: "Top Performers",
    rank: "Rank",
    totalSales: "Total Sales",
    agentPerformanceBreakdown: "Agent Performance Breakdown",
