		...
		children: [
			{
				titleKey: "callCenter",
				icon: Phone,
				href: "/ventas/call-center",
				disabled: false,
			},
			{
				titleKey: "frontDeskUpsell",
				icon: Users,
				href: "/ventas/front-desk-upsell",
				disabled: false,
			},
			{
			...
			{
				titleKey: "analiticaVentas",
				icon: BarChart3,
				href: "/ventas/sales-analytics",
				disabled: false,
			},
			{
				titleKey: "usuariosYComisiones",
				icon: UserCheck,
				href: "/ventas/usuarios-comisiones",
				disabled: false,
			},
		],
	},
...
export default function AppSidebar() {
		...
		return items.map((item) => {
			...
			if (item.children && item.children.length > 0) {
				...
				return (
					<SidebarMenuItem
						key={translatedTitle}
						className="group/collapsible-item mb-1"
					>
						<Collapsible
							open={isOpen}
	...
	return (
		<Sidebar className="border-r">
			<SidebarHeader className="border-b py-2.5 px-4">
				<div className="flex items-center gap-3">
			...
			<SidebarContent className="py-2">
				<SidebarMenu className="space-y-1">
					{renderNavItems(currentMenuItems)}
				</SidebarMenu>
			</SidebarContent>
