...
const getExtrasStatus = (hasItems: boolean, itemCount?: number) => {
  if (hasItems && itemCount) {
    // More realistic pricing based on item count (higher-value items for more requests)
    const basePrice = itemCount === 1 ? 25 : itemCount === 2 ? 20 : itemCount === 3 ? 18 : 15;
    const totalAmount = itemCount * basePrice + (itemCount > 2 ? Math.floor(Math.random() * 20) : 0);
...
export const mockReservations: Reservation[] = [
  ...
  { id: "3003", locator: "oct003", name: "María Rodríguez", email: "maria@rodriguez.com", checkIn: generateOctoberDate(0), nights: calculateNights(2), roomType: 'Deluxe', aci: "2/0/0", status: "New", extras: getExtrasStatus(true, 3), hasHotelverseRequest: false },
  { id: "3004", locator: "oct004", name: "José Martínez", email: "jose@martinez.com", checkIn: generateOctoberDate(0), nights: calculateNights(5), roomType: 'Suite', aci: "3/1/0", status: "New", extras: getExtrasStatus(true, 4), hasHotelverseRequest: true },
  { id: "3005", locator: "oct005", name: "Laura Sánchez", email: "laura@sanchez.com", checkIn: generateOctoberDate(0), nights: calculateNights(3), roomType: 'Presidential Suite', aci: "2/0/0", status: "New", extras: getExtrasStatus(true, 4), hasHotelverseRequest: false },
  ...
  { id: "3009", locator: "oct009", name: "Isabel Ruiz", email: "isabel@ruiz.com", checkIn: generateOctoberDate(0), nights: calculateNights(3), roomType: 'Suite', aci: "1/1/0", status: "New", extras: getExtrasStatus(true, 3), hasHotelverseRequest: false },
  { id: "3010", locator: "oct010", name: "Antonio Jiménez", email: "antonio@jimenez.com", checkIn: generateOctoberDate(0), nights: calculateNights(4), roomType: 'Presidential Suite', aci: "3/0/1", status: "New", extras: getExtrasStatus(true, 4), hasHotelverseRequest: true },
  { id: "3011", locator: "oct011", name: "Pilar Moreno", email: "pilar@moreno.com", checkIn: generateOctoberDate(0), nights: calculateNights(2), roomType: 'Standard', aci: "2/0/0", status: "New", extras: getExtrasStatus(true, 3), hasHotelverseRequest: false },
  ...
  { id: "3013", locator: "oct013", name: "Rosa Romero", email: "rosa@romero.com", checkIn: generateOctoberDate(0), nights: calculateNights(3), roomType: 'Deluxe', aci: "2/1/0", status: "New", extras: getExtrasStatus(true, 4), hasHotelverseRequest: false },
  { id: "3014", locator: "oct014", name: "Manuel Torres", email: "manuel@torres.com", checkIn: generateOctoberDate(0), nights: calculateNights(4), roomType: 'Suite', aci: "2/0/0", status: "New", extras: getExtrasStatus(true, 3), hasHotelverseRequest: true },
  { id: "3015", locator: "oct015", name: "Dolores Vázquez", email: "dolores@vazquez.com", checkIn: generateOctoberDate(0), nights: calculateNights(2), roomType: 'Presidential Suite', aci: "1/1/0", status: "New", extras: getExtrasStatus(true, 3), hasHotelverseRequest: false },
  { id: "3016", locator: "oct016", name: "Jesús Ramos", email: "jesus@ramos.com", checkIn: generateOctoberDate(0), nights: calculateNights(6), roomType: 'Standard', aci: "3/1/0", status: "New", extras: getExtrasStatus(true, 4), hasHotelverseRequest: true },
  { id: "3017", locator: "oct017", name: "Amparo Castro", email: "amparo@castro.com", checkIn: generateOctoberDate(0), nights: calculateNights(3), roomType: 'Superior', aci: "2/0/0", status: "New", extras: getExtrasStatus(true, 3), hasHotelverseRequest: false },
...
export const roomTypes = ['Standard', 'Superior', 'Deluxe', 'Suite', 'Presidential Suite'];
...
export const commissionReasons = [
  'Excellent upsell',
